import { Github, Linkedin, Twitter, Mail, Phone, ExternalLink, Download, Briefcase, GraduationCap, Newspaper, Code, Award, BookOpen, FileCode, Database, Book, Terminal, BadgeCheck, ArrowRight, Medal, Activity } from "lucide-react";
              ...
              {[
                {
                  ...
                  fullDescription: "Created a comprehensive cloud infrastructure automation solution that streamlines deployment processes and enhances scalability.",
                  ...
                  impact: "Reduced deployment time by 70% and improved resource utilization by 40%",
                ...
                },
                {
                  ...
                  fullDescription: "Developed an automated security compliance checking tool that ensures systems meet industry standards and best practices.",
                  tech: "Python, Docker, Jenkins, AWS",
                  features: [
                ...
                },
                {
                  ...
                  description: "Created an intelligent CI/CD pipeline optimization system",
                  fullDescription: "Developed a smart system that analyzes and optimizes CI/CD pipelines for maximum efficiency and reliability.",
                  tech: "Jenkins, GitLab CI, Python, Kubernetes",
                  features: [
                  ...
                  impact: "Reduced average build time by 45% and improved pipeline reliability by 30%",
                  githubUrl: "https://github.com/example/pipeline-optimizer",
                  icon: <Terminal className="size-5" />
                },
                {
                  title: "Infrastructure Monitoring Platform",
                  description: "Built a comprehensive infrastructure monitoring solution",
                  fullDescription: "Designed and implemented a modern infrastructure monitoring platform with advanced alerting and visualization capabilities.",
                  tech: "Prometheus, Grafana, Go, React",
                  features: [
                  ...
                  impact: "Improved system uptime by 25% and reduced incident response time by 50%",
                  demoUrl: "https://monitor.example.com",
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      {project.icon}
                      <h3 className="font-semibold group-hover:text-primary transition-colors font-mono">
                        {project.title}
                      </h3>
                    </div>
